...
Realizando los cálculos respectivos (consultables en `L5.ipynb`), se obtiene que el servidor debe antender más de 2,1081 solicitudes por minuto en promedio para garantizar de que más del 90% del tiempo haya al menos una solicitud en fila, es decir que no haya solicitudes sin atender.
